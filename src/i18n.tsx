...
const en: Copy = {
  ...
  hackEntry: "Entry",
  hackEntryBody: "Internal cohort and external teams. Three to five people. 24–48 hours.",
  hackOut: "Output",
...
const hi: Copy = {
  ...
  hackEntry: "प्रवेश",
  hackEntryBody: "आंतरिक कोहोर्ट और बाहरी टीमें। तीन से पाँच लोग। 24–48 घंटे।",
  hackOut: "आउटपुट",
